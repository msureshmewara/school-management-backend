...
@Table(name = "students", uniqueConstraints = {
    ...
    @UniqueConstraint(name = "uk_roll_class_school", columnNames = {"rollNumber", "school_id", "class_id"})
})
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class StudentEntity {
    ...
    @Column(nullable = false)
    private String className;  // Display only, real relation is below
    ...
    private String sssmidNum;
    private String aadharCardNum;
    private String rationCardNum;
    private String admissionFormNumber;
